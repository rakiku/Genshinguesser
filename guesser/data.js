...
// ===========================================================================
// 【重要】data.js の「function normalizeWeapon(raw) {」から
// ファイルの一番最後までのすべてを、以下のコードで丸ごと差し替えてください。
// ===========================================================================

// 1. 武器専用エリート敵素材のマッピング表を最優先で定義
const WEAPON_ENEMY_MATERIALS_MAP = {
  "風鷹剣": "重い角笛", "ダークアレイの閃光": "重い角笛", "腐食の剣": "重い角笛", "旧貴族長剣": "重い角笛", "西風剣": "重い角笛", "冷刃": "重い角笛", "銀の剣": "重い角笛", "無鋒の剣": "重い角笛", "松韻の響く頃": "重い角笛", "雪葬の星銀": "重い角笛", "鐘の剣": "重い角笛", "鉄影段平": "重い角笛", "旧貴族大剣": "重い角笛", "流月の針": "重い角笛", "西風長槍": "重い角笛", "喜多院十文字槍": "重い角笛", "千岩長槍": "重い角笛", "ムーンピアサー": "重い角笛", "鎮山の釘": "重い角笛", "プロスペクタードリル": "重い角笛", "正義の報酬": "重い角笛", "旧貴族長槍": "重い角笛", "玉響停の御噺": "重い角笛", "ダークアレイの狩人": "重い角笛", "黒岩の戦弓": "重い角笛", "落霞": "重い角笛", "トキの嘴": "重い角笛", "曚雲の月": "重い角笛", "チェーンブレイカー": "重い角笛", "レンジゲージ": "重い角笛", "祭礼の弓": "重い角笛", "烈日の後嗣": "重い角笛", "果てなき紺碧の唄": "重い角笛", "純水流華": "重い角笛", "白辰の輪": "重い角譜", "万国諸海の図譜": "重い角笛", "誓いの明導": "重い角笛", "旧貴族秘法録": "重い角笛", "ダークアレイの酒と詩": "重い角笛", "終焉を嘆く詩": "重い角笛", "幽夜のワルツ": "重い角笛", "蒼翠の狩猟弓": "重い角笛", "絶弦": "重い角笛", "鴉羽の弓": "重い角笛", "暁を告げる歴史": "重い角笛",
  ...
  "岩峰を巡る歌": "秘源のベアリング", "実りの鉤鉈": "秘源のベアリング", "千烈の日輪": "秘源 of 日輪", "千烈の日輪": "秘源のベアリング", "虹の行方": "秘源のベアリング", "蒼紋の角杯": "秘源のベアリング",
