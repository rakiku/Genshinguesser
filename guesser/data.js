...
const WEAPON_BASE_ATK = {
  ...
  542: ['聖顕の鍵','翠光の裁葉','三日月の含光','岩峰を巡る歌','盤岩結緑','静水流転の輝き','有楽御簾切','赤角石塵滅砕','赤砂の杖','雪葬の星銀','絶弦','千岩古剣','千夜に浮かぶ夢','草薙の稲光','蒼古なる自由への誓い','蒼翠の狩猟弓','蒼耀','霜契の金枝','霜辰','築雲','帳の夜曲','鶴鳴の余韻','鉄影段平','鉄尖槍','鉄蜂の刺し','天光のリュート','冬極の白星','冬忍びの実','特級の宝玉','虹の行方','波乗りの旋回','破天の槍','白影の剣','白辰の輪','盤岩結緑','不滅の月華','腐食の剣','風花の頌歌','風信の矛','風鷹剣','文使い','碧落の瓏','鉾槍','魔導緒論','万国諸海の図譜','万能の鍵','満悦の実','無工の剣','無鋒の剣','霧切の廻光','夜を紡ぐ天鏡','厄水の災い','幽夜のワルツ','有楽御簾切','傭兵の重剣','羅網の針','落霞','理屈責め','流月の針','流浪楽章','龍血を浴びた剣','龍殺しの英傑譚','旅道の剣','冷寂の音','冷刃','歴戦の狩猟弓','烈日の後嗣','狼の武勲詩','狼の末路','狼牙','和璞鳶','話死合い棒','凛流の監視者','匣中日月','匣中滅龍','匣中龍吟','彷徨える星','惡王丸','曚雲の月','澹月・試作','竭沢','籠釣瓶一心','翡玉法珠','銜玉の海皇','鴉羽の弓','黎明の神剣','螭龍の剣'],
...
const WEAPON_ATTRS = {
 ...
 　'和璞鳶':            { rarity: 5, weaponType: '長柄武器', enemyMaterial: '色褪せた赤い絹', ascension_stat: '会心率', is_distributed: false },
  ...
  'アースシェイカー':  { rarity: 4, weaponType: '両手剣', enemyMaterial: '波乱の幹材',   ascension_stat: '攻撃力', is_distributed: false },
