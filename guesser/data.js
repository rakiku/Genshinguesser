...
const RAW_CHARACTERS = [
  ...
  { name: "アリョーシャ", country: "スネージナヤ", weapon: "長柄武器", element: "雷", birth_month: "２月", birthday: "2月9日", version: "n.0", rarity: ['☆５'], body: "中身男性", role: ["オフフィールドサポーター","オフフィールドライフキーパー"], energy: 70, talent_boss: "合成獣・フリューゲルレーヴェ", local_specialty: "フロック草", ascension_stat: "元素チャージ効率", distributed: true, talent_book: "堅忍", talent_weekly: "異端の薬瓶", special_dish: "スタミナ軽減系", trace: false, costume: false, enemy_material: ["異種合成魔獣"], training_road: false, release_version: "7.0" },
...
const WEAPON_READINGS = {
  ...
  "新米の長槍": ["しんまいのながやり"],
  "森林のレガリア": ["しんりんのれがりあ"],
  "塵と光の七つの誓約": ["ちりとひかりとななつのせいやく"],
  "水仙十字の剣": ["すいせんじゅうじのけん"],
  "翠光の裁葉": ["すいこうのさいよう", "すいこうのさいは"],
  "星鎌・試作": ["ほしがましさく"],
  "正義の報酬": ["せいぎのほうしゅう"],
  "生徒ノート": ["せいとのーと"],
  "聖顕の鍵": ["せいけんのかぎ"],
  ...
  "蒼耀": ["そうよう"],
  "霜契の金枝": ["そうけつのきんし", "しもけつのきんし"],
  "霜辰": ["しもふり", "そうしん"],
  "築雲": ["ちくうん"],
  "帳の夜曲": ["とばりのよきょく", "とばりのやきょく"],
  "鶴鳴の余韻": ["かくめいのよいん"],
