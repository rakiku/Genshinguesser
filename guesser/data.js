...
const RAW_CHARACTERS = [
  ...
  { name: "アリョーシャ", country: "スネージナヤ", weapon: "長柄武器", element: "雷", birth_month: "２月", birthday: "2月9日", version: "n.0", rarity: ['☆４'], body: "中身男性", role: ["オフフィールドサポーター","オフフィールドライフキーパー"], energy: 0, talent_boss: "", local_specialty: "", ascension_stat: "", distributed: true, talent_book: "", talent_weekly: "", special_dish: "", trace: false, costume: false, enemy_material: [""], training_road: false, release_version: "7.0" },
  { name: "オデット", country: "スネージナヤ", weapon: "片手剣", element: "氷", birth_month: "２月", birthday: "2月20日", version: "n.0", rarity: ['☆５'], body: "中身女性", role: ["オフフィールドアタッカー"], energy: 0, talent_boss: "", local_specialty: "", ascension_stat: "", distributed: false, talent_book: "", talent_weekly: "", special_dish: "", trace: false, costume: false, enemy_material: [""], training_road: false, release_version: "7.0" },
  // 旅人（特殊：出題対象外）
