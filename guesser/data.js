...
// 💡 誤って消えていたこの部分（weaponGroups の定義）を元に戻します
...
const WEAPON_ENEMY_MATERIALS_MAP = {
  "風鷹剣": "重い角笛", "ダークアレイの閃光": "重い角笛", "腐食の剣": "重い角笛", "旧貴族長剣": "重い角笛", "西風剣": "重い角笛", "冷刃": "重い角笛", "銀の剣": "重い角笛", "無鋒の剣": "重い角笛", "松韻の響く頃": "重い角笛", "雪葬の星銀": "重い角笛", "鐘の剣": "重い角笛", "鉄影段平": "重い角笛", "旧貴族秘法録": "重い角笛", "西風秘典": "重い角笛", "魔導緒論": "重い角笛", "ポケット魔導書": "重い角笛", "生徒ノート": "重い角笛", "終焉を嘆く詩": "重い角笛", "幽夜のワルツ": "重い角笛", "蒼翠の狩猟弓": "重い角笛", "絶弦": "重い角笛", "鴉羽の弓": "重い角笛", "暁を告げる歴史": "重い角笛",
  ...
  "不滅の月華": "暗色のプリズム", "白辰の輪": "暗色のプリズム", "飛来 of 鳴弦": "暗色のプリズム", "破魔の弓": "暗色のプリズム", "曚雲の月": "暗色のプリズム", "プレデター": "暗色のプリズム",
  ...
  "月紡ぎの曙光": "失光の骨片", "万能の鍵": "失光 of 骨片", "災憾": "失光の骨片", "天光のリュート": "失光の骨片", "真言の匣": "失光の骨片",
...
const WEAPON_HINT_FIELDS = [
  ...
  // ★変更：従来の敵素材を「一般敵素材」にしてデフォルトを false に
  { key: 'enemyMaterial',          label: '一般敵素材',   type: 'exact',   defaultOn: false }, 
  
  // ★追加：新しく追加した武器専用のエリート敵素材をデフォルトONに
  { key: 'weaponEnemyMaterial',    label: 'エリート敵素材', type: 'exact', defaultOn: true },  
