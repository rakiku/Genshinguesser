...
const WEAPON_ATTRS = {
  ...
  '赤砂 of 杖':        { rarity:4, weaponType:'法器', enemyMaterial:'色褪せた赤い絹' },
  ...
  '無鋒 of 剣':        { rarity:3, weaponType:'片手剣', enemyMaterial:'破損した仮面' },
...
const WEAPON_ENEMY_MATERIALS_MAP = {
  ...
  "天空の刃": "地脈の旧枝", "降臨の剣": "地脈の旧枝", "黒剣": "地脈の旧枝", "笛の剣": "地脈の旧枝", "黎明の神剣": "地脈の旧枝", "天空の傲": "地脈の旧枝", "祭礼の大剣": "地脈の旧枝", "龍血を浴びた剣": "地脈の旧枝", "傭兵の重剣": "地脈の旧枝", "訓練用大剣": "地脈の旧枝", "護摩の杖": "地脈の旧枝", "死闘の槍": "地脈の旧枝", "天空の巻": "地脈の旧枝", "ドドコの物語": "地脈の旧枝", "ダークアレイの酒と詩": "地脈の旧枝", "流浪楽章": "地脈の旧枝", "龍殺しの英傑譚": "地脈の旧枝", "天空の翼": "地脈の旧枝", "風花の頌歌": "地脈の旧枝", "祭礼の弓": "地脈の旧枝", "歴戦の狩猟弓": "地脈の旧枝",
  "マーヴィカ": "従戦士の木笛", "キィニチ": "未熟な牙", "カチーナ": "従戦士の木笛", "ドゥリン": "破損した徽章", "シロネン": "従戦士の木笛",
};
