...
const WEEKLY_BOSS_GROUPS = {
  ...
  '北風のしっぽ': 'Boreas', '北風 of リング': 'Boreas', '北風の魂箱': 'Boreas',
...
const RAW_CHARACTERS = [
  ...
  { name: "香菱", country: "璃月", weapon: "長柄武器", element: "炎", birth_month: "１１月", birthday: "11月2日", rarity: ['☆４'], body: "中身女性", role: ["オフフィールドアタッカー"], energy: 80, talent_boss: "爆炎樹", local_specialty: "メカキノコ", ascension_stat: "元素熟知", distributed: true, talent_book: "勤労", talent_weekly: "東風の爪", special_dish: "継続回復系", trace: false, costume: true, enemy_material: ["スライムの液体"], training_road: false, release_version: "1.0" },
  ...
  { name: "ナヴィア", country: "フォンテーヌ", weapon: "両手剣", element: "岩", birth_month: "８月", birthday: "8月16日", rarity: ['☆５'], body: "長身女性", role: ["オンフィールドアタッカー"], energy: 60, talent_boss: "氷風組曲コペリウス", local_specialty: "初露の源", ascension_stat: "会心ダメージ", distributed: false, talent_book: "公平", talent_weekly: "光なき糸", special_dish: "スタミナ軽減系", trace: true, costume: false, enemy_material: ["異海の露"], training_road: false, release_version: "4.3" },
...
const HINT_FIELDS = [
  ...
  { key: 'body',              label: '体型',         type: 'exact',   defaultOn: false  },
  { key: 'releaseVersionNum', label: '実装Ver',       type: 'numeric', defaultOn: false  },
  ...
  { key: 'talentWeekly',      label: '週ボス素材',    type: 'group',   group: 'weeklyBossGroup', defaultOn: false  },
  { key: 'talentBoss',        label: '突破ボス',      type: 'exact',   defaultOn: true },
  { key: 'localSpecialty',    label: '特産品',        type: 'group',   group: 'localSpecialtyGroup', defaultOn: true  },
  { key: 'ascensionStat',     label: '突破ステ',      type: 'group',   group: 'ascensionStatGroup', defaultOn: false  },
  { key: 'specialDish',       label: 'オリジナル料理',      type: 'exact',   defaultOn: false },
  { key: 'distributed',       label: '配布',         type: 'exact',   defaultOn: false  },
...
const WEAPON_SOURCE_OVERRIDES = {
  ...
  "赤砂 of 杖": { rarity: 5, weaponType: "長柄武器" },
...
// 武器の実装バージョンデータの定義（消えていたデータをここに完全に復元します）
...
const WEAPON_TO_BREAK_MAT = {
  ...
  '万国諸海の図譜': '漆黒の隕鉄の塊', '浮世の錠': '漆黒の隕鉄の塊', 'リングボウ': '漆黒 of 隕鉄の塊', 'リングボウ': '漆黒の隕鉄の塊',
  ...
  // 鳴神御霊の勇武
  '波乱月白経津': '鳴神御霊 of 勇武', '波乱月白経津': '鳴神御霊の勇武', '東花坊時雨': '鳴神御霊の勇武', '桂木斬長正': '鳴神御霊の勇武',
  '赤角石塵滅砕': '鳴神御霊の勇武', '寝正月の初晴': '鳴神御霊の勇武', '飛来の鳴弦': '鳴神御霊の勇武',
  '破魔の弓': '鳴神御霊の勇武', 'プレデター': '鳴神御霊の勇武', '曚雲の月': '鳴神御霊の勇武',
  // 烈日権威の往日
  'マカイラの水色': '烈日権威 of 往日', 'マカイラの水色': '烈日権威の往日', '葦海の標': '烈日権威の往日', 'トゥライトゥーラの記憶': '烈日権威の往日',
  ...
  '赦罪': '悠久の弦の響き', '裁断': '悠久の弦 of 響き', '裁断': '悠久の弦の響き', 'プロスペクタードリル': '悠久の弦の響き',
  ...
  'ヴィヴィッド・ハート': '狂乱の聖主の神面', '逆水の災い': '狂乱の聖主の神面', '厄水の災い': '狂乱の聖主の神面',
  // 神秘なる煙の啓示
  '岩峰を巡る歌': '神秘なる煙の啓示', '蒼耀': '神秘なる煙の啓示',
  '蒼紋の角杯': '神秘なる煙の啓示', 'チェーンブレイカー': '神秘なる煙の啓示',
  '星鷲の紅き羽': '神秘なる煙の啓示', '花飾りの羽': '神秘なる煙 of 羽', '花飾りの羽': '神秘なる煙の啓示',
  '虹蛇の雨弦': '神秘なる煙の啓示',
  // 奇妙な装置の宿願
...
const WEAPON_BASE_ATK = {
  ...
  565: ['黒岩の長剣','厄水の災い','海淵のフィナーレ','月紡ぎの曙光','斬岩・試作','王の近侍','ストロングボーン','「スーパーアルティメット覇王魔剣」','アースシェイカー','森林のレガリア','実りの鉤鉈','鉄彩の花','古華・試作','祭礼の大剣','雪葬の星銀','話死合い棒','旧貴族大剣','流月の針','西風長槍','喜多院十文字槍','千岩長槍','ムーンピアサー','鎮山の釘','プロスペクタードリル','正義の報酬','旧貴族長槍','玉響停の御噺','ダークアレイの狩人','黒岩の戦弓','落霞','トキの嘴','曚雲の月','チェーンブレイカー','レンジゲージ','祭礼の弓','烈日の後嗣','果てなき紺碧の唄','純水流華','白辰の輪','万国諸海の図譜','誓いの明瞳','旧貴族秘法録','ダークアレイの酒と詩'],
  542: ['聖顕の鍵','翠光の裁葉','三日月の含光','岩峰を巡る歌','盤岩結緑','静水流転の輝き','有楽御簾切','赤角石塵滅砕','赤砂の杖','雪葬の星銀','絶弦','千岩古剣','千夜に浮かぶ夢','草薙の稲光','蒼古なる自由への誓い','蒼翠の狩猟弓','蒼耀','霜契の金枝','霜辰','築雲','帳の夜曲','鶴鳴の余韻','鉄影段平','鉄尖槍','鉄蜂の刺し','天光のリュート','冬極の白星','冬忍びの実','特級の宝玉','虹の行方','波乗りの旋回','破天の槍','白影の剣','白辰の輪','盤岩結緑','不滅 of 月華','不滅の月華','腐食の剣','風花の頌歌','風信の矛','風鷹剣','文使い','碧落の瓏','鉾槍','魔導緒論','万国諸海の図譜','万能の鍵','満悦の実','無工の剣','無鋒の剣','霧切の廻光','夜を紡ぐ天鏡','厄水の災い','幽夜のワルツ','有楽御簾切','傭兵の重剣','羅網の針','落霞','理屈責め','流月の針','流浪楽章','龍血を浴びた剣','龍殺しの英傑譚','旅道の剣','冷寂の音','冷刃','歴戦の狩猟弓','烈日の後嗣','狼の武勲詩','狼の末路','狼牙','和璞鳶','話死合い棒','凛流の監視者','匣中日月','匣中滅龍','匣中龍吟','彷徨える星','惡王丸','曚雲の月','澹月・試作','竭沢','籠釣瓶一心','翡玉法珠','銜玉の海皇','鴉羽の弓','黎明の神剣','螭龍の剣'],
...
const WEAPON_ATTRS = {
  // ★5 片手剣
 '三日月の含光':      { rarity: 5, weaponType: '片手剣', enemyMaterial: '宝探しの鴉マーク', ascension_stat: '会心ダメージ', is_distributed: false },
  '黒蝕':              { rarity: 5, weaponType: '片手剣', enemyMaterial: '新兵の記章',     ascension_stat: '会心率', is_distributed: false },
  '岩峰を巡る歌':      { rarity: 5, weaponType: '片手剣', enemyMaterial: '従戦士の木笛',   ascension_stat: '防御力', is_distributed: false },
  '赦罪':              { rarity: 5, weaponType: '片手剣', enemyMaterial: '異海の露',       ascension_stat: '会心ダメージ', is_distributed: false },
  ...
  '翠光の裁葉':        { rarity: 5, weaponType: '片手剣', enemyMaterial: 'スライムの液体',   ascension_stat: '会心ダメージ', is_distributed: false },
  '聖顕の鍵':          { rarity: 5, weaponType: '片手剣', enemyMaterial: 'フライムの乾核',   ascension_stat: 'HP', is_distributed: false },
  '風鷹剣':            { rarity: 5, weaponType: '片手剣', enemyMaterial: '破損した仮面',   ascension_stat: '物理ダメージ', is_distributed: false },
  '霧切の廻光':        { rarity: 5, weaponType: '片手剣', enemyMaterial: '古びた鍔',       ascension_stat: '会心ダメージ', is_distributed: false },
  '蒼古なる自由への誓い':{ rarity: 5, weaponType: '片手剣', enemyMaterial: '破損した仮面',   ascension_stat: '元素熟知', is_distributed: false },
  ...
  '斬山の刃':          { rarity: 5, weaponType: '片手剣', enemyMaterial: '新兵の記章',     ascension_stat: '攻撃力', is_distributed: false },
  '天空の刃':          { rarity: 5, weaponType: '片手剣', enemyMaterial: '新兵の記章',     ascension_stat: '元素チャージ効率', is_distributed: false },
  '蒼耀':              { rarity: 5, weaponType: '片手剣', enemyMaterial: '従戦士の木笛',   ascension_stat: '会心率', is_distributed: false },
  // ★5 両手剣
  '狼の武勲詩':        { rarity: 5, weaponType: '両手剣', enemyMaterial: 'スライムの液体',   ascension_stat: '会心率', is_distributed: false },
  '超越の鍵':          { rarity: 5, weaponType: '両手剣', enemyMaterial: '破損した駆動軸',   ascension_stat: '会心ダメージ', is_distributed: false },
  '千烈の日輪':        { rarity: 5, weaponType: '両手剣', enemyMaterial: '波乱の幹材',     ascension_stat: '会心率', is_distributed: false },
  '山の王の長牙':      { rarity: 5, weaponType: '両手剣', enemyMaterial: '従戦士の木笛',   ascension_stat: '会心率', is_distributed: false },
  '裁断':              { rarity: 5, weaponType: '両手剣', enemyMaterial: '異海の露',       ascension_stat: '会心率', is_distributed: false },
  ...
  '狼の末路':          { rarity: 5, weaponType: '両手剣', enemyMaterial: '破損した仮面',   ascension_stat: '攻撃力', is_distributed: false },
  '松韻の響く頃':      { rarity: 5, weaponType: '両手剣', enemyMaterial: 'スライムの液体',   ascension_stat: '物理ダメージ', is_distributed: false },
  '無工の剣':          { rarity: 5, weaponType: '両手剣', enemyMaterial: '古びた鍔',       ascension_stat: '攻撃力', is_distributed: false },
  '天空の傲':          { rarity: 5, weaponType: '両手剣', enemyMaterial: '新兵の記章',     ascension_stat: '元素チャージ効率', is_distributed: false },
  // ★5 長柄武器
 　'和璞鳶':            { rarity: 5, weaponType: '長柄武器', enemyMaterial: '色褪せた赤い絹', ascension_stat: '会心率', is_distributed: false },
  '天空の脊':          { rarity: 5, weaponType: '長柄武器', enemyMaterial: '新兵の記章',     ascension_stat: '元素チャージ効率', is_distributed: false },
  '護摩の杖':          { rarity: 5, weaponType: '長柄武器', enemyMaterial: '新兵の記章',     ascension_stat: '会心ダメージ', is_distributed: false },
  '息災':              { rarity: 5, weaponType: '長柄武器', enemyMaterial: '色褪せた赤い絹', ascension_stat: '攻撃力', is_distributed: false },
  '草薙の稲光':        { rarity: 5, weaponType: '長柄武器', enemyMaterial: '古びた鍔',       ascension_stat: '元素チャージ効率', is_distributed: false },
  '破天の槍':          { rarity: 5, weaponType: '長柄武器', enemyMaterial: '色褪せた赤い絹', ascension_stat: '攻撃力', is_distributed: false },
  '血染めの荒れ地':    { rarity: 5, weaponType: '長柄武器', enemyMaterial: '色褪せた赤い絹', ascension_stat: '会心率', is_distributed: false },
  '香りのシンフォニスト':{ rarity: 5, weaponType: '長柄武器', enemyMaterial: '従戦士の木笛',   ascension_stat: '会心ダメージ', is_distributed: false },
  '砕け散る光輪':      { rarity: 5, weaponType: '長柄武器', enemyMaterial: '従戦士の木笛',   ascension_stat: '会心ダメージ', is_distributed: false },
  'ルミドゥースの挽歌':{ rarity: 5, weaponType: '長柄武器', enemyMaterial: '色褪せた赤い絹', ascension_stat: '会心率', is_distributed: false },
  '赤月のシルエット':  { rarity: 5, weaponType: '長柄武器', enemyMaterial: '異海の露',       ascension_stat: '会心率', is_distributed: false },
  '赤砂の杖':          { rarity: 5, weaponType: '長柄武器', enemyMaterial: '色褪せた赤い絹', ascension_stat: '会心率', is_distributed: false },
  '災憾':              { rarity: 5, weaponType: '長柄武器', enemyMaterial: '従戦士の木笛',   ascension_stat: '会心率', is_distributed: false },
  // ★5 弓
  '霜契 of 金枝':        { rarity: 5, weaponType: '弓', enemyMaterial: '破損した徽章',   ascension_stat: '会心ダメージ', is_distributed: false },
  '霜契の金枝':        { rarity: 5, weaponType: '弓', enemyMaterial: '破損した徽章',   ascension_stat: '会心ダメージ', is_distributed: false },
  '暁を告げる歴史':    { rarity: 5, weaponType: '弓', enemyMaterial: '牢固な矢先',     ascension_stat: '会心ダメージ', is_distributed: false },
  ...
  '始まりの大魔術':    { rarity: 5, weaponType: '弓', enemyMaterial: '宝探しの鴉マーク', ascension_stat: '会心ダメージ', is_distributed: false },
  '狩人の道':          { rarity: 5, weaponType: '弓', enemyMaterial: '色褪せた赤い絹', ascension_stat: '会心率', is_distributed: false },
  '若水':              { rarity: 5, weaponType: '弓', enemyMaterial: '新兵の記章',     ascension_stat: '会心ダメージ', is_distributed: false },
  '飛来の鳴弦':        { rarity: 5, weaponType: '弓', enemyMaterial: '古びた鍔',       ascension_stat: '会心ダメージ', is_distributed: false },
  ...
  '天空の翼':          { rarity: 5, weaponType: '弓', enemyMaterial: '新兵の記章',     ascension_stat: '会心率', is_distributed: false },
  '冬極の白星':        { rarity: 5, weaponType: '弓', enemyMaterial: '古びた鍔',       ascension_stat: '会心率', is_distributed: false },
  // ★5 法器
  '帳の夜曲':          { rarity: 5, weaponType: '法器', enemyMaterial: '破損した駆動軸',   ascension_stat: '会心ダメージ', is_distributed: false },
  '真言の匣':          { rarity: 5, weaponType: '法器', enemyMaterial: '色褪せた赤い絹', ascension_stat: '会心ダメージ', is_distributed: false },
  '夜を紡ぐ天鏡':      { rarity: 5, weaponType: '法器', enemyMaterial: '破損した駆動軸',   ascension_stat: '元素熟知',     is_distributed: false },
  'ヴィヴィッド・ハート':{ rarity: 5, weaponType: '法器', enemyMaterial: '従戦士の木笛',   ascension_stat: '会心ダメージ', is_distributed: false },
  '寝正月の初晴':      { rarity: 5, weaponType: '法器', enemyMaterial: '古びた鍔',       ascension_stat: '元素熟知',     is_distributed: false },
  '祭星者の眺め':      { rarity: 5, weaponType: '法器', enemyMaterial: '未熟な牙',       ascension_stat: '元素熟知',     is_distributed: false },
  'サーフィンタイム':  { rarity: 5, weaponType: '法器', enemyMaterial: '未熟な牙',       ascension_stat: '会心ダメージ', is_distributed: false },
  '鶴鳴の余韻':        { rarity: 5, weaponType: '法器', enemyMaterial: '色褪せた赤い絹', ascension_stat: '攻撃力',       is_distributed: false },
  ...
  'トゥライトゥーラの記憶':{ rarity: 5, weaponType: '法器', enemyMaterial: '波乱の幹材',     ascension_stat: '会心ダメージ', is_distributed: false },
  '千夜に浮かぶ夢':    { rarity: 5, weaponType: '法器', enemyMaterial: '色褪せた赤い絹', ascension_stat: '元素熟知',     is_distributed: false },
  '神楽の真意':        { rarity: 5, weaponType: '法器', enemyMaterial: '古びた鍔',       ascension_stat: '会心ダメージ', is_distributed: false },
  '浮世の錠':          { rarity: 5, weaponType: '法器', enemyMaterial: '古びた鍔',       ascension_stat: '攻撃力',       is_distributed: false },
  '天空の巻':          { rarity: 5, weaponType: '法器', enemyMaterial: '新兵の記章',     ascension_stat: '攻撃力',       is_distributed: false },
  '四風原典':          { rarity: 5, weaponType: '法器', enemyMaterial: '新兵の記章',     ascension_stat: '会心率',       is_distributed: false },
  '不滅の月華':      { rarity: 5, weaponType: '法器', enemyMaterial: '古びた鍔',       ascension_stat: 'HP',           is_distributed: false },
  ...
  '静謐の笛':          { rarity: 4, weaponType: '片手剣', enemyMaterial: '破損した駆動軸',   ascension_stat: '元素チャージ効率', is_distributed: false },
  '厄水の災い':        { rarity: 4, weaponType: '片手剣', enemyMaterial: 'フライムの乾核',   ascension_stat: '攻撃力', is_distributed: true },
  'ストロングボーン':  { rarity: 4, weaponType: '片手剣', enemyMaterial: '未熟な牙',       ascension_stat: '攻撃力', is_distributed: false },
  ...
  'サーンドルの渡し守':{ rarity: 4, weaponType: '片手剣', enemyMaterial: '宝探しの鴉マーク', ascension_stat: '元素チャージ効率', is_distributed: false },
  '海淵 of フィナーレ':  { rarity: 4, weaponType: '片手剣', enemyMaterial: '異海の露',       ascension_stat: '攻撃力', is_distributed: false },
  '海淵のフィナーレ':  { rarity: 4, weaponType: '片手剣', enemyMaterial: '異海の露',       ascension_stat: '攻撃力', is_distributed: false },
  '東花坊時雨':        { rarity: 4, weaponType: '片手剣', enemyMaterial: '古びた鍔',       ascension_stat: '元素熟知', is_distributed: true },
  'サイフォスの月明かり':{ rarity: 4, weaponType: '片手剣', enemyMaterial: 'キノコンの胞子', ascension_stat: '元素熟知', is_distributed: false },
  '原木刀':            { rarity: 4, weaponType: '片手剣', enemyMaterial: '色褪せた赤い絹', ascension_stat: '元素チャージ効率', is_distributed: false },
  '籠釣瓶一心':        { rarity: 4, weaponType: '片手剣', enemyMaterial: '古びた鍔',       ascension_stat: '攻撃力', is_distributed: false },
  '黒岩の長剣':        { rarity: 4, weaponType: '片手剣', enemyMaterial: '新兵の記章',     ascension_stat: '会心ダメージ', is_distributed: false },
  '黒剣':              { rarity: 4, weaponType: '片手剣', enemyMaterial: '新兵の記章',     ascension_stat: '会心率', is_distributed: false },
  '降臨の剣':          { rarity: 4, weaponType: '片手剣', enemyMaterial: '新兵の記章',     ascension_stat: '攻撃力', is_distributed: false },
  '鉄蜂の刺し':        { rarity: 4, weaponType: '片手剣', enemyMaterial: '牢固な矢先',     ascension_stat: '元素熟知', is_distributed: false },
  'シナバースピンドル':{ rarity: 4, weaponType: '片手剣', enemyMaterial: '古びた鍔',       ascension_stat: '防御力', is_distributed: true },
  '斬岩・試作':        { rarity: 4, weaponType: '片手剣', enemyMaterial: '新兵の記章',     ascension_stat: '物理ダメージ', is_distributed: false },
  '西風剣':            { rarity: 4, weaponType: '片手剣', enemyMaterial: '新兵の記章',     ascension_stat: '元素チャージ効率', is_distributed: false },
  '腐食の剣':          { rarity: 4, weaponType: '片手剣', enemyMaterial: '牢固な矢先',     ascension_stat: '元素チャージ効率', is_distributed: true },
  '笛の剣':            { rarity: 4, weaponType: '片手剣', enemyMaterial: '新兵の記章',     ascension_stat: '攻撃力', is_distributed: false },
  '祭礼の剣':          { rarity: 4, weaponType: '片手剣', enemyMaterial: '新兵の記章',     ascension_stat: '元素チャージ効率', is_distributed: false },
  'ダークアレイの閃光':{ rarity: 4, weaponType: '片手剣', enemyMaterial: '新兵の記章',     ascension_stat: '元素熟知', is_distributed: false },
  '旧貴族長剣':        { rarity: 4, weaponType: '片手剣', enemyMaterial: '新兵の記章',     ascension_stat: '攻撃力', is_distributed: false },
  '天目影打':          { rarity: 4, weaponType: '片手剣', enemyMaterial: '古びた鍔',       ascension_stat: '攻撃力', is_distributed: false },
  '匣中龍吟':          { rarity: 4, weaponType: '片手剣', enemyMaterial: '色褪せた赤い絹', ascension_stat: '攻撃力', is_distributed: false },
  // ★4 両手剣
  '万能の鍵':          { rarity: 4, weaponType: '両手剣', enemyMaterial: '破損した駆動軸',   ascension_stat: '元素チャージ効率', is_distributed: false },
  '実りの鉤鉈':        { rarity: 4, weaponType: '両手剣', enemyMaterial: '従戦士の木笛',   ascension_stat: '攻撃力', is_distributed: false },
  'アースシェイカー':  { rarity: 4, weaponType: '両手剣', enemyMaterial: '波乱 of 幹材',   ascension_stat: '攻撃力', is_distributed: false },
  '「スーパーアルティメット覇王魔剣」':{ rarity: 4, weaponType: '両手剣', enemyMaterial: '異海の露',       ascension_stat: '元素チャージ効率', is_distributed: true },
  '携帯型チェンソー':  { rarity: 4, weaponType: '両手剣', enemyMaterial: '異海の露',       ascension_stat: 'HP', is_distributed: false },
  '話死合い棒':        { rarity: 4, weaponType: '両手剣', enemyMaterial: 'キノコンの胞子', ascension_stat: '会心率', is_distributed: false },
  'タイダル・シャドー':{ rarity: 4, weaponType: '両手剣', enemyMaterial: '異海の露',       ascension_stat: '攻撃力', is_distributed: false },
  '鉄彩の花':          { rarity: 4, weaponType: '両手剣', enemyMaterial: '牢固な矢先',     ascension_stat: '元素熟知', is_distributed: true },
  'マカイラの水色':    { rarity: 4, weaponType: '両手剣', enemyMaterial: '色褪せた赤い絹', ascension_stat: '元素熟知', is_distributed: false },
  '森林のレガリア':    { rarity: 4, weaponType: '両手剣', enemyMaterial: '色褪せた赤い絹', ascension_stat: '元素チャージ効率', is_distributed: false },
  '黒岩の斬刀':        { rarity: 4, weaponType: '両手剣', enemyMaterial: '色褪せた赤い絹', ascension_stat: '会心ダメージ', is_distributed: false },
  '雪葬の星銀':        { rarity: 4, weaponType: '両手剣', enemyMaterial: '古びた鍔',       ascension_stat: '物理ダメージ', is_distributed: false },
  '雨裁':              { rarity: 4, weaponType: '両手剣', enemyMaterial: '色褪せた赤い絹', ascension_stat: '元素熟知', is_distributed: false },
  '鐘の剣':            { rarity: 4, weaponType: '両手剣', enemyMaterial: '破損した仮面',   ascension_stat: 'HP', is_distributed: false },
  '古華・試作':        { rarity: 4, weaponType: '両手剣', enemyMaterial: '破損した仮面',   ascension_stat: '攻撃力', is_distributed: false },
  '西風大剣':          { rarity: 4, weaponType: '両手剣', enemyMaterial: '牢固な矢先',     ascension_stat: '元素チャージ効率', is_distributed: false },
  '銜玉の海皇':        { rarity: 4, weaponType: '両手剣', enemyMaterial: 'フライムの乾核',   ascension_stat: '攻撃力', is_distributed: true },
  '螭龍の剣':          { rarity: 4, weaponType: '両手剣', enemyMaterial: 'トリックフラワーの蜜', ascension_stat: '会心率', is_distributed: false },
  '祭礼の大剣':        { rarity: 4, weaponType: '両手剣', enemyMaterial: '新兵の記章',     ascension_stat: '元素チャージ効率', is_distributed: false },
  '白影の剣':          { rarity: 4, weaponType: '両手剣', enemyMaterial: '新兵の記章',     ascension_stat: '防御力', is_distributed: false },
  ...
  '旧貴族大剣':        { rarity: 4, weaponType: '両手剣', enemyMaterial: '新兵の記章',     ascension_stat: '攻撃力', is_distributed: false },
  '千岩古剣':          { rarity: 4, weaponType: '両手剣', enemyMaterial: '色褪せた赤い絹', ascension_stat: '攻撃力', is_distributed: false },
  '知恵の溶炎':        { rarity: 4, weaponType: '両手剣', enemyMaterial: '従戦士の木笛',   ascension_stat: '元素熟知', is_distributed: true },
  // ★4 長柄武器
  '喜多院十文字槍':    { rarity: 4, weaponType: '長柄武器', enemyMaterial: '古びた鍔',       ascension_stat: '元素熟知', is_distributed: false },
  '千岩長槍':          { rarity: 4, weaponType: '長柄武器', enemyMaterial: '色褪せた赤い絹', ascension_stat: '攻撃力', is_distributed: false },
  '聖祭者の輝杖':      { rarity: 4, weaponType: '長柄武器', enemyMaterial: '色褪せた赤い絹', ascension_stat: '会心率', is_distributed: false },
  '金堀りのシャベル':  { rarity: 4, weaponType: '長柄武器', enemyMaterial: '新兵の記章',     ascension_stat: '攻撃力', is_distributed: false },
  '玉響停の御噺':      { rarity: 4, weaponType: '長柄武器', enemyMaterial: '古びた鍔',       ascension_stat: '元素チャージ効率', is_distributed: true },
  '鎮山の釘':          { rarity: 4, weaponType: '長柄武器', enemyMaterial: '従戦士の木笛',   ascension_stat: '元素チャージ効率', is_distributed: false },
  '虹の行方':          { rarity: 4, weaponType: '長柄武器', enemyMaterial: '従戦士の木笛',   ascension_stat: '防御力', is_distributed: false },
  '砂中の賢者達の問答':{ rarity: 4, weaponType: '長柄武器', enemyMaterial: '色褪せた赤い絹', ascension_stat: 'HP', is_distributed: true },
  'プロスペクタードリル':{ rarity: 4, weaponType: '長柄武器', enemyMaterial: '異海の露',       ascension_stat: '攻撃力', is_distributed: false },
  'フィヨルドの歌':    { rarity: 4, weaponType: '長柄武器', enemyMaterial: '異海の露',       ascension_stat: '会心率', is_distributed: false },
  '正義の報酬':        { rarity: 4, weaponType: '長柄武器', enemyMaterial: '異海の露',       ascension_stat: 'HP', is_distributed: false },
  '風信の矛':          { rarity: 4, weaponType: '長柄武器', enemyMaterial: 'キノコンの胞子', ascension_stat: '攻撃力', is_distributed: true },
  'ムーンピアサー':    { rarity: 4, weaponType: '長柄武器', enemyMaterial: 'キノコンの胞子', ascension_stat: '元素熟知', is_distributed: false },
  'ドラゴンスピア':    { rarity: 4, weaponType: '長柄武器', enemyMaterial: 'キノコンの胞子', ascension_stat: '物理ダメージ', is_distributed: false },
  '西風長槍':          { rarity: 4, weaponType: '長柄武器', enemyMaterial: '牢固な矢先',     ascension_stat: '元素チャージ効率', is_distributed: false },
  '旧貴族長槍':        { rarity: 4, weaponType: '長柄武器', enemyMaterial: '新兵の記章',     ascension_stat: '攻撃力', is_distributed: false },
  '流月の針':          { rarity: 4, weaponType: '長柄武器', enemyMaterial: '色褪せた赤い絹', ascension_stat: '物理ダメージ', is_distributed: false },
  '「漁獲」':          { rarity: 4, weaponType: '長柄武器', enemyMaterial: '古びた鍔',       ascension_stat: '元素チャージ効率', is_distributed: false },
  '黒岩の突槍':        { rarity: 4, weaponType: '長柄武器', enemyMaterial: '色褪せた赤い絹', ascension_stat: '会心ダメージ', is_distributed: false },
  '話死合い棒':        { rarity: 4, weaponType: '長柄武器', enemyMaterial: 'キノコンの胞子', ascension_stat: '会心率', is_distributed: false },
  '星鎌・試作':        { rarity: 4, weaponType: '長柄武器', enemyMaterial: '色褪せた赤い絹', ascension_stat: '元素チャージ効率', is_distributed: false },
  ...
  '匣中滅龍':          { rarity: 4, weaponType: '長柄武器', enemyMaterial: 'キノコンの胞子', ascension_stat: '元素熟知', is_distributed: false },
  '死闘の槍':          { rarity: 4, weaponType: '長柄武器', enemyMaterial: '新兵の記章',     ascension_stat: '会心率', is_distributed: false },
  
  // ★4 弓
　'虹蛇の雨弦':        { rarity: 4, weaponType: '弓', enemyMaterial: '従戦士の木笛',   ascension_stat: '元素チャージ効率', is_distributed: true },
  '羅網の針':          { rarity: 4, weaponType: '弓', enemyMaterial: '破損した徽章',   ascension_stat: '元素チャージ効率', is_distributed: false },
  '冷寂の音':          { rarity: 4, weaponType: '弓', enemyMaterial: '宝探しの鴉マーク', ascension_stat: 'HP', is_distributed: true },
  '花飾りの羽':        { rarity: 4, weaponType: '弓', enemyMaterial: '未熟な牙',       ascension_stat: '攻撃力', is_distributed: false },
  'チェーンブレイカー':{ rarity: 4, weaponType: '弓', enemyMaterial: '未熟な牙',       ascension_stat: '', is_distributed: false },
  '築雲':              { rarity: 4, weaponType: '弓', enemyMaterial: '占いの絵巻',     ascension_stat: '元素熟知', is_distributed: true },
  'レンジゲージ':      { rarity: 4, weaponType: '弓', enemyMaterial: '異海の露',       ascension_stat: '攻撃力', is_distributed: false },
  '烈日の後嗣':        { rarity: 4, weaponType: '弓', enemyMaterial: '色褪せた赤い絹', ascension_stat: '会心率', is_distributed: false },
  '静寂の唄':          { rarity: 4, weaponType: '弓', enemyMaterial: '異海の露',       ascension_stat: '攻撃力', is_distributed: false },
  'トキの嘴':          { rarity: 4, weaponType: '弓', enemyMaterial: '色褪せた赤い絹', ascension_stat: '攻撃力', is_distributed: true },
  '王の近侍':          { rarity: 4, weaponType: '弓', enemyMaterial: '色褪せた赤い絹', ascension_stat: '攻撃力', is_distributed: false },
  '竭沢':              { rarity: 4, weaponType: '弓', enemyMaterial: 'キノコンの胞子',   ascension_stat: '元素チャージ効率', is_distributed: false },
  '落霞':              { rarity: 4, weaponType: '弓', enemyMaterial: '新兵の記章',     ascension_stat: '元素チャージ効率', is_distributed: true },
  '黒岩の戦弓':        { rarity: 4, weaponType: '弓', enemyMaterial: '色褪せた赤い絹', ascension_stat: '会心ダメージ', is_distributed: false },
  '風花の頌歌':        { rarity: 4, weaponType: '弓', enemyMaterial: '新兵の記章',     ascension_stat: '元素熟知', is_distributed: true },
  'リングボウ':        { rarity: 4, weaponType: '弓', enemyMaterial: '新兵の記章',     ascension_stat: '物理ダメージ', is_distributed: false },
  '澹月・試作':        { rarity: 4, weaponType: '弓', enemyMaterial: '占いの絵巻',     ascension_stat: '攻撃力', is_distributed: false },
  '西風猟弓':          { rarity: 4, weaponType: '弓', enemyMaterial: '牢固な矢先',     ascension_stat: '元素チャージ効率', is_distributed: false },
  ...
  '祭礼の弓':          { rarity: 4, weaponType: '弓', enemyMaterial: '新兵の記章',     ascension_stat: '元素チャージ効率', is_distributed: false },
  '破魔の弓':          { rarity: 4, weaponType: '弓', enemyMaterial: '古びた鍔',       ascension_stat: '攻撃力', is_distributed: false },
  '曚雲の月':          { rarity: 4, weaponType: '弓', enemyMaterial: '古びた鍔',       ascension_stat: '攻撃力', is_distributed: false },
  'ダークアレイの狩人':{ rarity: 4, weaponType: '弓', enemyMaterial: '牢固な矢先',     ascension_stat: '攻撃力', is_distributed: false },
  'プレデター':        { rarity: 4, weaponType: '弓', enemyMaterial: '占いの絵巻',     ascension_stat: '攻撃力', is_distributed: false },
  '弓蔵':              { rarity: 4, weaponType: '弓', enemyMaterial: '色褪せた赤い絹', ascension_stat: '攻撃力', is_distributed: false },
  '幽夜のワルツ':      { rarity: 4, weaponType: '弓', enemyMaterial: '占いの絵巻',     ascension_stat: '物理ダメージ', is_distributed: false },
  '旧貴族長弓':        { rarity: 4, weaponType: '弓', enemyMaterial: '新兵の記章',     ascension_stat: '攻撃力', is_distributed: false },
  // ★4 法器
 　'霜辰':              { rarity: 4, weaponType: '法器', enemyMaterial: '破損した徽章',   ascension_stat: '会心ダメージ', is_distributed: false },
  '天光のリュート':    { rarity: 4, weaponType: '法器', enemyMaterial: '破損した駆動軸',   ascension_stat: '元素チャージ効率', is_distributed: true },
  ...
  'ヤシュチェの環':    { rarity: 4, weaponType: '法器', enemyMaterial: '従戦士の木笛',   ascension_stat: 'HP',           is_distributed: false },
  '蒼紋の角杯':        { rarity: 4, weaponType: '法器', enemyMaterial: '従戦士の木笛',   ascension_stat: 'HP',           is_distributed: true },
  '果てなき紺碧の唄':  { rarity: 4, weaponType: '法器', enemyMaterial: '新兵の記章',     ascension_stat: '元素チャージ効率', is_distributed: true },
  '古祠の瓏':          { rarity: 4, weaponType: '法器', enemyMaterial: 'スライムの液体',   ascension_stat: '会心率',       is_distributed: false },
  '純水流華':          { rarity: 4, weaponType: '法器', enemyMaterial: '異海の露',       ascension_stat: '攻撃力',       is_distributed: false },
  '彷徨える星':        { rarity: 4, weaponType: '法器', enemyMaterial: '色褪せた赤い絹', ascension_stat: '元素熟知',     is_distributed: false },
  '満悦の実':          { rarity: 4, weaponType: '法器', enemyMaterial: 'キノコンの胞子',   ascension_stat: '元素チャージ効率', is_distributed: false },
  '黒岩の緋玉':        { rarity: 4, weaponType: '法器', enemyMaterial: '色褪せた赤い絹', ascension_stat: '会心ダメージ', is_distributed: false },
  '金珀・試作':        { rarity: 4, weaponType: '法器', enemyMaterial: '占いの絵巻',     ascension_stat: 'HP',           is_distributed: false },
  '誓いの明瞳':        { rarity: 4, weaponType: '法器', enemyMaterial: 'フライムの乾核',   ascension_stat: '攻撃力',       is_distributed: true },
  '西風秘典':          { rarity: 4, weaponType: '法器', enemyMaterial: '破損した仮面',   ascension_stat: '元素チャージ効率', is_distributed: false },
  '祭礼の断片':        { rarity: 4, weaponType: '法器', enemyMaterial: '新兵の記章',     ascension_stat: '元素熟知',     is_distributed: false },
  '白辰の輪':          { rarity: 4, weaponType: '法器', enemyMaterial: '古びた鍔',       ascension_stat: '元素チャージ効率', is_distributed: false },
  '流浪楽章':          { rarity: 4, weaponType: '法器', enemyMaterial: '新兵の記章',     ascension_stat: '会心ダメージ', is_distributed: false },
  'ダークアレイの酒と詩':{ rarity: 4, weaponType: '法器', enemyMaterial: '牢固な矢先',     ascension_stat: '元素チャージ効率', is_distributed: false },
  '昭心':              { rarity: 4, weaponType: '法器', enemyMaterial: 'スライムの液体',   ascension_stat: '攻撃力',       is_distributed: false },
  '冬忍びの実':        { rarity: 4, weaponType: '法器', enemyMaterial: '新兵の記章',     ascension_stat: '攻撃力',       is_distributed: false },
  '旧貴族秘法録':      { rarity: 4, weaponType: '法器', enemyMaterial: '新兵の記章',     ascension_stat: '攻撃力',       is_distributed: false },
  'ドドコの物語':      { rarity: 4, weaponType: '法器', enemyMaterial: '占いの絵巻',     ascension_stat: '攻撃力',       is_distributed: true },
  '匣中日月':          { rarity: 4, weaponType: '法器', enemyMaterial: '色褪せた赤い絹', ascension_stat: '会心率',       is_distributed: false },
  '万国諸海の図譜':    { rarity: 4, weaponType: '法器', enemyMaterial: 'スライムの液体',   ascension_stat: '元素熟知',     is_distributed: false },
  // ★3 片手剣
　'黎明の神剣':        { rarity: 3, weaponType: '片手剣', enemyMaterial: '占いの絵巻',     ascension_stat: '会心ダメージ', is_distributed: false },
  '飛天御剣':          { rarity: 3, weaponType: '片手剣', enemyMaterial: 'スライムの液体',   ascension_stat: '元素チャージ効率', is_distributed: false },
  '暗鉄剣':            { rarity: 3, weaponType: '片手剣', enemyMaterial: '破損した仮面',   ascension_stat: '元素熟知', is_distributed: false },
  '旅道の剣':          { rarity: 3, weaponType: '片手剣', enemyMaterial: '新兵の記章',     ascension_stat: '防御力', is_distributed: false },
  'チ虎魚の刀':        { rarity: 3, weaponType: '片手剣', enemyMaterial: '新兵の記章',     ascension_stat: '攻撃力', is_distributed: false },
  '冷刃':              { rarity: 3, weaponType: '片手剣', enemyMaterial: '新兵の記章',     ascension_stat: '攻撃力', is_distributed: false },
  // ★3 両手剣
　'飛天大御剣':        { rarity: 3, weaponType: '両手剣', enemyMaterial: 'スライムの液体',   ascension_stat: '物理ダメージ', is_distributed: false },
  '鉄影段平':          { rarity: 3, weaponType: '両手剣', enemyMaterial: '破損した仮面',   ascension_stat: 'HP', is_distributed: false },
  '白鉄の大剣':        { rarity: 3, weaponType: '両手剣', enemyMaterial: '新兵の記章',     ascension_stat: '防御力', is_distributed: false },
  '龍血を浴びた剣':    { rarity: 3, weaponType: '両手剣', enemyMaterial: 'スライムの液体',   ascension_stat: '元素熟知', is_distributed: false },
  '理屈責め':          { rarity: 3, weaponType: '両手剣', enemyMaterial: 'スライムの液体',   ascension_stat: '攻撃力', is_distributed: false },
  // ★3 長柄武器
  '鉾槍':              { rarity: 3, weaponType: '長柄武器', enemyMaterial: '新兵の記章',     ascension_stat: '攻撃力', is_distributed: false },
  '白纓槍':            { rarity: 3, weaponType: '長柄武器', enemyMaterial: '色褪せた赤い絹', ascension_stat: '会心率', is_distributed: false },
  '黒纓槍':            { rarity: 3, weaponType: '長柄武器', enemyMaterial: 'スライムの液体', ascension_stat: 'HP', is_distributed: false },
  
  // ★3 弓
  '鴉羽の弓':          { rarity: 3, weaponType: '弓', enemyMaterial: '新兵の記章',     ascension_stat: '元素熟知', is_distributed: false },
  'シャープシューターの誓い':{ rarity: 3, weaponType: '弓', enemyMaterial: '牢固な矢先',     ascension_stat: '会心ダメージ', is_distributed: false },
  '弾弓':              { rarity: 3, weaponType: '弓', enemyMaterial: '色褪せた赤い絹', ascension_stat: '会心率', is_distributed: false },
  'リカーブボウ':      { rarity: 3, weaponType: '弓', enemyMaterial: '牢固な矢先',     ascension_stat: 'HP', is_distributed: false },
  '文使い':            { rarity: 3, weaponType: '弓', enemyMaterial: '新兵の記章',     ascension_stat: '会心ダメージ', is_distributed: false },
  // ★3 法器
 　'魔導緒論':          { rarity: 3, weaponType: '法器', enemyMaterial: 'スライムの液体',   ascension_stat: '元素熟知',     is_distributed: false },
  '龍殺しの英傑譚':    { rarity: 3, weaponType: '法器', enemyMaterial: '破損した仮面',   ascension_stat: 'HP',           is_distributed: false },
  '翡玉法珠':          { rarity: 3, weaponType: '法器', enemyMaterial: '色褪せた赤い絹', ascension_stat: '元素熟知',     is_distributed: false },
  '特級の宝玉':        { rarity: 3, weaponType: '法器', enemyMaterial: '新兵の記章',     ascension_stat: '会心率',       is_distributed: false },
  '異世界旅行記':      { rarity: 3, weaponType: '法器', enemyMaterial: '牢固な矢先',     ascension_stat: '元素チャージ効率', is_distributed: false },
  // ★2 片手剣
 　'銀の剣':            { rarity: 2, weaponType: '片手剣', enemyMaterial: '破損した仮面',   ascension_stat: '', is_distributed: false },
  // ★2 両手剣
  '傭兵の重剣':        { rarity: 2, weaponType: '両手剣', enemyMaterial: 'スライムの液体',   ascension_stat: '', is_distributed: false },
  // ★2 長柄武器
  '鉄尖槍':            { rarity: 2, weaponType: '長柄武器', enemyMaterial: '新兵の記章',     ascension_stat: '', is_distributed: false },
  // ★2 弓
  '歴戦の狩猟弓':      { rarity: 2, weaponType: '弓', enemyMaterial: 'スライムの液体',   ascension_stat: '', is_distributed: false },
  // ★2 法器
  'ポケット魔導書':    { rarity: 2, weaponType: '法器', enemyMaterial: '破損した仮面',   ascension_stat: '',             is_distributed: false },
  // ★1 片手剣
  '無鋒の剣':          { rarity: 1, weaponType: '片手剣', enemyMaterial: '破損した仮面',   ascension_stat: '', is_distributed: false },
  // ★1 両手剣
  '訓練用大剣':        { rarity: 1, weaponType: '両手剣', enemyMaterial: 'スライムの液体',   ascension_stat: '', is_distributed: false },
  // ★1 長柄武器
  '新米の長槍':        { rarity: 1, weaponType: '長柄武器', enemyMaterial: '新兵の記章',     ascension_stat: '', is_distributed: false },
  // ★1 弓
  '狩猟弓':            { rarity: 1, weaponType: '弓', enemyMaterial: 'スライムの液体',   ascension_stat: '', is_distributed: false },
  // ★1 法器  
  '生徒ノート':        { rarity: 1, weaponType: '法器', enemyMaterial: '新兵の記章',     ascension_stat: '',  is_distributed: false },
};

// ===========================================================================
// 目印：ここからファイルの最下部（一番最後）まで丸ごと以下のコードに置き換えてください。
// ===========================================================================

// 1. 武器生データを自動生成する関数（※完全に正常な定義です）
function buildWeaponBase() {
  ...
  for (const name of allNames) {
    ...
    weapons.push({
      ...
      isDistributed: !!attrs.is_distributed, // 正常な属性参照に修正
    });
  }
  return weapons;
}
...
// 4. 武器専用エリート敵素材のマッピング表を定義
const WEAPON_ENEMY_MATERIALS_MAP = {
  "風鷹剣": "重い角笛", "ダークアレイの閃光": "重い角笛", "腐食の剣": "重い角笛", "旧貴族長剣": "重い角笛", "西風剣": "重い角笛", "冷刃": "重い角笛", "銀の剣": "重い角笛", "無鋒の剣": "重い角笛", "松韻の響く頃": "重い角笛", "雪葬の星銀": "重い角笛", "鐘の剣": "重い角笛", "鉄影段平": "重い角笛", "旧貴族大剣": "重い角笛", "流月の針": "重い角笛", "西風長槍": "重い角笛", "喜多院十文字槍": "重い角笛", "千岩長槍": "重い角笛", "ムーンピアサー": "重い角笛", "鎮山の釘": "重い角笛", "プロスペクタードリル": "重い角笛", "正義の報酬": "重い角笛", "旧貴族長槍": "重い角笛", "玉響停の御噺": "重い角笛", "ダークアレイの狩人": "重い角笛", "黒岩の戦弓": "重い角笛", "落霞": "重い角笛", "トキの嘴": "重い角笛", "曚雲の月": "重い角笛", "チェーンブレイカー": "重い角笛", "レンジゲージ": "重い角笛", "祭礼の弓": "重い角笛", "烈日の後嗣": "重い角笛", "果てなき紺碧の唄": "重い角笛", "純水流華": "重い角笛", "白辰の輪": "重い角笛", "万国諸海の図譜": "重い角笛", "誓いの明導": "重い角笛", "旧貴族秘法録": "重い角笛", "ダークアレイの酒と詩": "重い角笛", "終焉を嘆く詩": "重い角笛", "幽夜のワルツ": "重い角笛", "蒼翠の狩猟弓": "重い角笛", "絶弦": "重い角笛", "鴉羽の弓": "重い角笛", "暁を告げる歴史": "重い角笛",
  "盤岩結緑": "霧虚ろの花粉", "斬岩・試作": "霧虚ろの花粉", "チ虎魚の刀": "霧虚ろの花粉", "無工の剣": "霧虚ろの花粉", "黒岩の長剣": "霧虚ろの花粉", "雨裁": "霧虚ろの花粉", "理屈責め": "霧虚ろの花粉", "息災": "霧虚ろの花粉", "ドラゴンスピア": "霧虚ろの花粉", "旧貴族長槍": "霧虚ろの花粉", "黒岩の突槍": "霧虚ろの花粉", "匣中滅龍": "霧虚ろの花粉", "鉾槍": "霧虚ろの花粉", "昭心": "霧虚ろの花粉", "金珀・試作": "霧虚ろの花粉", "特級の宝玉": "霧虚ろの花粉", "古祠の瓏": "霧虚ろの花粉", "澹月・試作": "霧虚ろの花粉", "文使い": "霧虚ろの花粉",
  "赤角石塵滅砕": "隠獣の指爪", "惡王丸": "隠獣の指爪", "斬場のひれ長": "隠獣の指爪", "神楽の真意": "隠獣の指爪", "誓いの明瞳": "隠獣の指爪", "冬極の白星": "隠獣の指爪",
  "鉄蜂の刺し": "脆い骨片", "飛天御剣": "脆い骨片", "銜玉の海皇": "脆い骨片", "飛天大御剣": "脆い骨片", "螭龍の剣": "脆い骨片", "古華・試作": "脆い骨片", "破天の槍": "脆い骨片", "千岩長槍": "脆い骨片", "星鎌・試作": "脆い骨片", "黒纓槍": "脆い骨片", "浮世の錠": "脆い骨片", "万国諸海の図譜": "脆い骨片", "果てなき紺碧の唄": "脆い骨片", "リングボウ": "脆い骨片",
  ...
  "原木刀": "混沌ストレージ", "マカイラの水色": "混沌ストレージ", "森林のレガリア": "混沌ストレージ", "ムーンピアサー": "混沌ストレージ",
  "トゥライトゥーラの記憶": "キノコンの衰菌核", "彷徨える星": "キノコンの衰菌核", "狩人の道": "キノコンの衰菌核", "竭沢": "キノコンの衰菌核", "王の近侍": "キノコンの衰菌核",
  "超越の鍵": "欠損した月の鉄",
  "塵と光の七つの誓約": "光を失った焔剣の柄", "霜契の金枝": "光を失った焔剣の柄",
  "狼の武勲詩": "暗黒の裂眼", "帳の夜曲": "暗黒の裂眼",
  "三日月の含光": "暗き霧の欠片", "血染めの荒れ地": "暗き霧の欠片", "金堀りのシャベル": "暗き霧の欠片", "聖祭者の輝杖": "暗き霧の欠片", "羅網の針": "暗き霧の欠片",
  "月紡ぎの曙光": "失光の骨片", "万能の鍵": "失光の骨片", "災憾": "失光の骨片", "天光のリュート": "失光の骨片", "真言の匣": "失光の骨片",
  "静謐の笛": "霜夜の残光", "黒蝕": "霜夜の残光", "夜を紡ぐ天鏡": "霜夜の残光", "烏髄の孤灯": "霜夜の残光", "霜辰": "霜夜の残光",
  "知恵の溶炎": "冷えた鱗甲の欠片", "砕け散る光輪": "冷えた鱗甲の欠片", "ヴィヴィッド・ハート": "冷えた鱗甲の欠片", "冷寂の音": "冷えた鱗甲の欠片",
  ...
  "エズピツァルの笛": "砕けた剣の柄", "赤月のシルエット": "砕けた剣の柄", "ルミドゥースの挽歌": "砕けた剣の柄", "築雲": "砕けた剣の柄",
  ...
  "碧落の瓏": "何処かで摘まれた咲きかけの花", "トキの嘴": "何処かで摘まれた咲きかけの花", "烈日の後嗣": "何処かで摘まれた咲きかけの花",
  "翠光の裁葉": "毀れた背骨", "葦海の標": "毀れた背骨", "鉄彩の花": "毀れた背骨", "話死合い棒": "毀れた背骨",
  "聖顕の鍵": "壊れたプリズム", "東花坊時雨": "壊れたプリズム", "サイフォスの月明かり": "壊れたプリズム", "千夜に浮かぶ夢": "壊れたプリズム"
};
