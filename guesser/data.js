...
const WEAPON_TO_BREAK_MAT = {
  ...
  // 凛風奔狼の郷愁
  '降臨の剣': '凛風奔狼の郷愁', '笛 of 剣': '凛風奔狼の郷愁', '笛の剣': '凛風奔狼の郷愁', '黒剣': '凛風奔狼の郷愁',
  '天空の刃': '凛風奔狼の郷愁', '黎明の神剣': '凛風奔狼の郷愁', '龍血を浴びた剣': '凛風奔狼の郷愁',
  '訓練用大剣': '凛風奔狼の郷愁', '傭兵の重剣': '凛風奔狼の郷愁', '天空の傲': '凛風奔狼の郷愁',
  '祭礼の大剣': '凛風奔狼の郷愁', 'キー': '凛風奔狼の郷愁', 'キー': '凛風奔狼の郷愁', '狼の武勲詩': '凛風奔狼の郷愁', '風信の矛': '凛風奔狼の郷愁',
...
const WEAPON_BASE_ATK = {
  ...
  565: ['黒岩の長剣','厄水の災い','海淵のフィナーレ','月紡ぎの曙光','斬岩・試作','王の近侍','ストロングボーン','「スーパーアルティメット覇王魔剣」','アースシェイカー','森林のレガリア','実りの鉤鉈','鉄彩の花','古華・試作','祭礼の大剣','雪葬の星銀','話死合い棒','旧貴族大剣','流月の針','西風長槍','喜多院十文字槍','千岩長槍','ムーンピアサー','鎮山の釘','プロスペクタードリル','正義の報酬','旧貴族長槍','玉響停の御噺','ダークアレイの狩人','黒岩の戦弓','落霞','トキの嘴','曚雲の月','チェーンブレイカー','レンジゲージ','祭礼の弓','烈日の後嗣','果てなき紺碧の唄','純水流華','白辰の輪','万国諸海の図譜','誓いの明瞳','旧貴族秘法録','ダークアレイ of 酒と詩','ダークアレイの酒と詩'],
...
const WEAPON_BASE_ATK = {
  ...
  674: ['赦罪','風鷹剣','蒼耀','霧切の廻光','天空の傲','裁断','血染めの荒れ地','赤月のシルエット','和璞鳶','天空の脊','天空の翼','暁を告げる歴史','凛流の監視者','天空の巻','トゥライトゥーラの記憶','ヴィヴィッド・ハート','災憾','万能の鍵'],
  620: ['ダークアレイの閃光','聖祭者の輝杖','斬波のひれ長'],
  608: ['黒蝕','蒼古なる自由への誓い','波乱月白経津','天空の刃','斬山の刃','葦海の標','狼の武勲詩','無工の剣','狼の末路','草薙の稲光','砕け散る光輪','ルミドゥースの挽歌','護摩の杖','香りのシンフォニスト','破天の槍','アモスの弓','星鷲の紅き羽','終焉を嘆く詩','冬極 of 白星', '冬極の白星','始まりの大魔術','飛来の鳴弦','不滅の月華','碧落の瓏','神楽の真意','四風原典','浮世の錠'],
...
function buildWeaponBase() {
  ...
  for (const name of allNames) {
    ...
    // 🟢 変更点：weaponReleaseVersionMap になくても "1.0" として読み込む
    ...
    weapons.push({
      ...
      ascensionStat: attrs.ascension_stat || '', // 🟢 変更点：attrs.ascension_stat (アンダーバー付き) に修正
...
const WEAPON_ENEMY_MATERIALS_MAP = {
  ...
  // 隠獣の指爪
  "赤角石塵滅砕": "隠獣の指爪", "惡王丸": "隠獣の指爪", "斬波のひれ長": "隠獣の指爪", "斬波のひれ長": "隠獣の指爪", "神楽の真意": "隠獣の指爪", "誓いの明瞳": "隠獣の指爪", "冬極の白星": "隠獣の指爪",
  ...
  // 暗黒の裂眼
  "狼の武勲詩": "暗黒の裂眼", "帳 of 夜曲": "暗黒の裂眼", "帳の夜曲": "暗黒の裂眼",

  // 暗き霧の欠片
  "三日月の含光": "暗き霧の欠片", "血染めの荒れ地": "暗き霧の欠片", "金掘りのシャベル": "暗き霧の欠片", "金堀りのシャベル": "暗き霧の欠片", "聖祭者の輝杖": "暗き霧の欠片", "羅網の針": "暗き霧の欠片",
